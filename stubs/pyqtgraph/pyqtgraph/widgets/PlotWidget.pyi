...
class PlotWidget(GraphicsView):
    ...
    def setYRange(self, min, max, padding=None, update: bool = True) -> None: ...  # type: ignore[override]
    def setXRange(self, min, max, padding=None, update: bool = True) -> None: ...  # type: ignore[override]
