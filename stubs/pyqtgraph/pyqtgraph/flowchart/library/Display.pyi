...
class PlotWidgetNode(Node):
    ...
    def getPlot(self): ...
    def process(self, In, display: bool = True) -> None: ...  # type: ignore[override]
...
class PlotCurve(CtrlNode):
    ...
    item: Incomplete
    def __init__(self, name) -> None: ...
    def process(self, x, y, display: bool = True): ...  # type: ignore[override]
...
class ScatterPlot(CtrlNode):
    ...
    keys: Incomplete
    def __init__(self, name) -> None: ...
    def process(self, input, display: bool = True): ...  # type: ignore[override]
