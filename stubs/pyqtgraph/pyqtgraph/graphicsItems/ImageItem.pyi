...
class ImageItem(GraphicsObject):
    ...
    def setLevels(self, levels: ArrayLike | None, update: bool = True) -> None: ...
    ...
    def updateImage(self, *args, **kargs) -> None: ...
    ...
    def getHistogram(
        ...
        step: int | tuple[int, int] | Literal["auto"] = "auto",
    ...
    def setDrawKernel(
        ...
        # A callable is invoked as `mode(kernel, image, mask, srcSlice, targetSlice, ev)`.
        mode: Literal["set", "add"] | Callable[..., object] = "set",
    ) -> None: ...
