...
# Anything `mkPen` accepts: a `QPen`, a color, a dict of pen options, or `None`
# for "no pen".
_PenArg: TypeAlias = _ColorArg | Mapping[str, Any] | None
# Anything `mkBrush` accepts: a `QBrush`, a color, or `None` for "no brush".
_BrushArg: TypeAlias = _ColorArg | None
...
def mkBrush(*args: _BrushArg, **kwds: _BrushArg): ...
def mkPen(*args: _PenArg, **kargs): ...
